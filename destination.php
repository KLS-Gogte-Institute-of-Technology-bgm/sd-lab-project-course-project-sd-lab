...
<html>
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="active"><a href="destination.php">Export</a></li>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/export.jpg)">
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<h3>Export a new Product</h3>
					<form method="post" action="destination.php">

						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Name</label>
								<input name="name" type="text" id="name" class="form-control" placeholder="Exporter Name">
							</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="product" type="text" id="product" class="form-control" placeholder="Product Trading Name">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input name="price" type="text" id="price" class="form-control" placeholder="Price Per Kg ( in ₹)">
							</div>
						</div>
						 ...
						 <div class="row form-group">
							<div class="col-md-12">
								...
								<input id="file" type="file" class="" name="file" >
							</div>
						</div>
		...
		if($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			$query="INSERT INTO exporter(name,product,₹,image) VALUES('$name','$product','$price','$filename')";
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>Previous Export Products</h2>
					<p>All Products.</p>
				</div>
			</div>
			<div class="row">
				<?php $q="SELECT product,₹,image FROM exporter WHERE name='abc';";
